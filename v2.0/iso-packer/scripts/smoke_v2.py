...
def verify_static_contracts() -> None:
    ...
    require("点击有匹配结果的卡片" in index_html, "index.html missing local asset TMDB link copy")
    ...
    require("任务名：" not in index_html, "local asset cards should not expose task-name labels")
